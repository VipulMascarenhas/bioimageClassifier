...
dataframe_train = pd.read_csv('../Data/EASY_TRAIN.csv', header=None)
dataset_train = dataframe_train.values
# choose the first 26 columns as training examples
data_train = dataframe_train.ix[:,0:25]
# choose the 27th column as the training labels
labels_train = dataframe_train.ix[:,26]


dataframe_test = pd.read_csv('../Data/EASY_TEST.csv', header=None)
...
print("Classification report for random classifier %s:\n%s\n"
  % (r_clf, metrics.classification_report(labels_expected, r_labels_predicted)))
